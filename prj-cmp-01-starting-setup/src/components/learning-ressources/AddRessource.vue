<template>
    <base-dialog v-if="inputIsInvalid" title="Invalid Input" @close="confirmError">
        <template #default>
            ...
            <p>Please check all inputs and make sure you enter few characters</p>
        </template>
        <template #actions>
            <primary-button @click="confirmError">OKAY</primary-button>
        </template>
    </base-dialog>
    <base-card>
        <form @submit.prevent="submitData"> 
            ...
            <div>
                <primary-button type="submit">Add Ressource</primary-button>
            </div>
        </form>
    </base-card>
